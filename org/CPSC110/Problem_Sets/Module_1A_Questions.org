...
[[file:~/johnrmao.github.io/org/CPSC110/Module-1A.org][Module 1A Notes]]
...
(define checkifh
  (lambda (phrase)
    (if (string-ci=? (string-ith phrase 0) "h") ; checks if the first letter of phrase is equal to "h"
        "true"
        "false")
    )
  )
