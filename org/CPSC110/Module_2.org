...
(define (aspect-ratio img) ; () and [] balance each other. Both are equavalent but by convention, we use[ ] around question/answer pairs in cond. This makes the cond easier to read.
