...
+ The HtDF and HtDD recipes are largely orthogonal.
  + HtDF works nearly the same way for all forms of data.


+ Once we learn a new form of data, we already mostly know how to design functions that operate on it.
* Interval
* Enumeration
* Itemization
* HtDF with Interval
